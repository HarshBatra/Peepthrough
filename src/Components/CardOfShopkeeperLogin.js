...
function CardOfShopkeeperLogin() {
  return (
    <div className="">
      <div
        className="md:w-100 mx-10 px-14 py-16 rounded-[20px]"
        style={{
          background:
      ...
      >
        <div className="flex flex-col">
          <h1 className="md:text-3xl text-2xl font-bold">
            Please enter your <span className="text-primary-blue">Login</span>{" "}
            details
          </h1>
          ...
          <button
            className={`${CSSComponents.roundButtonBlue} drop-shadow-[5px_5px_20px_rgba(0,0,0,0.25)] mt-9`}
          >
            Login
          </button>
        </div>
