...
const Advertise = () => {
  return (
    <div className="h-full my-20 flex justify-center items-center">
      <div
        class="flex flex-col gap-6 p-10 rounded-3xl  bg-gradient-to-br from-[#13A89E47]  to-[#13A89E00]  items-center "
        style={{
          "box-shadow": "5px 5px 20px 2px rgba(0, 0, 0, 0.25)",
        }}
      >
        <div className=" text-center ">
          <span className=" text-2xl font-bold text-teal-500 tracking-wider  leading-10">
            Advertise
          </span>
          ...
          <div>
            <form action="" className="newsletter text-[.8rem] font-semibold">
              <div className="name flex flex-col mt-6 gap-[.4rem]">
                ...
                <input
                  name="fullname"
                  className="bg-[rgba(255, 255, 255, 0.5)] rounded-2xl h-8 pl-4 -mx-2 w-full"
                  type="text"
              ...
              <div
                name="contactname"
                className="name flex flex-col mt-4 gap-[.4rem]"
              >
                <p>Contact Person</p>
                <input
                  className="bg-[rgba(255, 255, 255, 0.5)] rounded-2xl h-8 pl-4 -mx-2 w-full"
              ...
              <div
                name="phonenum"
                className="number flex flex-col mt-4 gap-[.4rem]"
              >
                <p>Contact No.</p>
                <input
                  className="bg-[rgba(255, 255, 255, 0.5)] rounded-2xl h-8 pl-4 -mx-2 w-full"
              ...
              <div
                name="email"
                className="email flex flex-col mt-4 gap-[.4rem]"
              >
                <p>Email</p>
                <input
                  className="bg-[rgba(255, 255, 255, 0.5)] rounded-2xl h-8 pl-4 -mx-2 w-full"
