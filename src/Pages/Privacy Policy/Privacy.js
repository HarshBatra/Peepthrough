    ...
    return (
        <div class='m-10 p-10 grid place-content-center justify-items-center' >
            ...
            <div class='text-justify m-10 p-10 font-medium tracking-wider text-base font-poppins opacity-80 '>
                In the course of registering for and availing listing services we provide through our website www.peepthrough.com or any other medium in which peepthrough may provide services (collectively referred to as "Media") you may be required to give your name, residence address, email address, business details, business address and similar personal or professional information. This information is used for three general purposes: to customize the content you see, to fulfill your requests for certain services, and to contact you about our services via including but not limited to email's, sms’s and other means of communication. Unless otherwise stated explicitly, this Policy applies to Personal Information as disclosed on any of the Media.
                ...
                If you have questions or concerns about these privacy policies; please send us an email at privacy@peepthrough.com
